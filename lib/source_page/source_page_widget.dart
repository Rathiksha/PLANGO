              ...
              Align(
                ...
                child: Padding(
                  ...
                  child: FlutterFlowRadioButton(
                    options: ['Instagram', 'Blog/Action', 'Referral'].toList(),
                    onChanged: (val) async {
                      safeSetState(() {});
                      safeSetState(() {});
                    },
                    controller: _model.soValueController ??=
              ...
              FFButtonWidget(
                onPressed: () async {
                  context.pushNamed(
                    ...
                    queryParameters: {
                      'finalcity': serializeParam(
                        '',
                        ParamType.String,
                      ),
                      'finalbudget': serializeParam(
                        '',
                        ParamType.String,
                      ),
                      'finalvibe': serializeParam(
                        '',
                        ParamType.String,
                      ),
                      'sourcepage': serializeParam(
                        '',
                        ParamType.String,
                      ),
                    }.withoutNulls,
