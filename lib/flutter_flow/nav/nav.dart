      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => SourcePageWidget(
            selectedCity: params.getParam(
              'selectedCity',
              ParamType.String,
            ),
            selectedBudget: params.getParam(
              'selectedBudget',
              ParamType.String,
            ),
            selectedVibe: params.getParam(
              'selectedVibe',
              ParamType.String,
            ),
          ),
        ...
        FFRoute(
          ...
          builder: (context, params) => ResultWidget(
            finalcity: params.getParam(
              'finalcity',
              ParamType.String,
            ),
            finalbudget: params.getParam(
              'finalbudget',
              ParamType.String,
            ),
            finalvibe: params.getParam(
              'finalvibe',
              ParamType.String,
            ),
            sourcepage: params.getParam(
              'sourcepage',
              ParamType.String,
            ),
          ),
